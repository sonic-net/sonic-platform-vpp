...
$(DOCKER_SONIC_VPP)_DEPENDS += $(SWSS) \
                              $(SYNCD_VPP) \
                              $(LIBVPP) \
                              $(PYTHON_SWSSCOMMON) \
                              $(PYTHON3_SWSSCOMMON) \
...
$(DOCKER_SONIC_VPP)_DEPENDS += $(SWSS_DBG) \
                              $(LIBSWSSCOMMON_DBG) \
                              $(LIBSAIREDIS_DBG) \
                              $(LIBSAIVPP_DBG) \
                              $(SYNCD_VPP_DBG)
...
$(DOCKER_SONIC_VPP)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_BUSTER)
SONIC_DOCKER_IMAGES += $(DOCKER_SONIC_VPP)

SONIC_BUSTER_DOCKERS += $(DOCKER_SONIC_VPP)
