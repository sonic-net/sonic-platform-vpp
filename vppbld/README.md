...
The version of vpp packages is specified in sonic-buildimage/rules/vpp.mk. When we build target/sonic-vpp.img.gz or libvppinfra, for example target/debs/trixie/libvppinfra_2506-0.2+b1sonic1_amd64.deb, it will trigger above Makefile.
